...
public class Aula07ImportandoGrafoSimplesPonderadoCSVMatrix {
	...
	public static void main(String[] args) {
		...
		SimpleWeightedGraph <DefaultVertex,DefaultWeightedEdge> graph = 
		 ...
		 ImportUtil.importWeightedGraphCSV(graph, pathGraph + "hamiltonian.csv",CSVFormat.MATRIX,false,true,true);
